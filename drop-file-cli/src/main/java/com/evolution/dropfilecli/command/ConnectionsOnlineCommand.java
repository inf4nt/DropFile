...
public class ConnectionsOnlineCommand implements Runnable {
    ...
    @Autowired
    public ConnectionsOnlineCommand(DaemonClient daemonClient) {
        this.daemonClient = daemonClient;
    }

    @Override
    public void run() {
        ConnectionsOnline onlineConnections = daemonClient.getOnlineConnections();
        List<ConnectionsOnline.Online> onlineList = onlineConnections.getOnlineList();
        ...
        if (onlineConnections.getOnlineList().isEmpty()) {
