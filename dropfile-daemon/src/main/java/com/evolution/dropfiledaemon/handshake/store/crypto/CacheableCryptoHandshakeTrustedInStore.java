...
public class CacheableCryptoHandshakeTrustedInStore
    ...
    public CacheableCryptoHandshakeTrustedInStore(FileHelper fileHelper, ObjectMapper objectMapper, CryptoTunnel cryptoTunnel, Path parrentDirectoryPath) {
        super(new CryptoHandshakeTrustedInStore(fileHelper, objectMapper, cryptoTunnel, parrentDirectoryPath));
    }
}
