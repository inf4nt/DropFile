...
@Component
public class PayloadTimeoutValidationTunnelServerDispatcherChain implements TunnelServerDispatcherChain {
    ...
    public void doChain(TunnelDispatcherChainProcessorContext ctx,
        ...
        long requestTime = Math.abs(System.currentTimeMillis() - ctx.payload().timestamp());
