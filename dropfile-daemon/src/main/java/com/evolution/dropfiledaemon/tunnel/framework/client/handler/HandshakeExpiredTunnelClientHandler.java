...
import com.evolution.dropfiledaemon.tunnel.framework.client.exception.TunnelClientHandshakeExpiredException;
...
public class HandshakeExpiredTunnelClientHandler implements TunnelClientHandler {
    ...
    public int getStatusCode() {
        return TunnelServerDispatcherStatus.HANDSHAKE_EXPIRED.getStatusCode();
    }
